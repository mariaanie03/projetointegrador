document.addEventListener('DOMContentLoaded', function() {
    ...
    const todosOsProdutos = [
        ...
        { id: 3, nome: 'Kit Dia Especial', preco: 'R$ 80,00', imagem: 'imagens/cesta-basica-do-amor-laina-editavel-6-removebg-preview.png', descricao: 'Um kit pensado para celebrar momentos, com itens personalizáveis.' },
        { id: 4, nome: 'Kit Chocolate', preco: 'R$ 45,00', imagem: 'imagens/presente_criativo_1-removebg-preview.png', descricao: 'A combinação perfeita de chocolates deliciosos e um item personalizado.' },
